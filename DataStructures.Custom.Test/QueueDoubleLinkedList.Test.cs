...
public class QueueDoubleLinkedList_Test
{
    private readonly QueueDoubleLinkedList<int> myQueue;

    public QueueDoubleLinkedList_Test()
    {
        this.myQueue = new QueueDoubleLinkedList<int>();
    }
